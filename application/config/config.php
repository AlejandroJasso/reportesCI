...
|
*/ 
//Permite configurar una URL para nuestro proyecto, una vez configurada en nuestros archivos podemos utilizar: base_url()
$config['base_url'] = 'http://localhost/reportesCI/';
...
|
*/
//$config['index_page'] = 'index.php'; //Configuracíón inicial
$config['index_page'] = '';
